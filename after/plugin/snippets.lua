...
ls.add_snippets("all", {
  ...
  s("gcl", {
    i(0),
    t("console.log('\x1b[32m%s\x1b[0m',"),
    i(1),
    t(")"),
    i(2)
  }),
  ...
  s("rcl", {
    i(0),
    t("console.log('\x1b[31m%s\x1b[0m',"),
    i(1),
    t(")"),
    i(2)
  }),
  ...
  s("bcl", {
    i(0),
    t("console.log('\x1b[34m%s\x1b[0m',"),
    i(1),
    t(")"),
    i(2)
  }),
  ...
  s("pcl", {
    i(0),
    t("console.log('\x1b[35%m%s\x1b[0m',"),
    i(1),
    t(")"),
    i(2)
  }),
  ...
  s("cycl", {
    i(0),
    t("console.log('\x1b[36%m%s\x1b[0m',"),
    i(1),
    t(")"),
    i(2)
  }),
  -- Black Background Console Log
  s("bbcl", {
    i(0),
    t("console.log('\x1b[40m%s\x1b[0m',"),
    i(1),
    t(")"),
    i(2)
  }),
  -- Red Background Console Log
  s("rbcl", {
    i(0),
    t("console.log('\x1b[41m%s\x1b[0m',"),
    i(1),
    t(")"),
    i(2)
  }),
  -- Green Background Console Log
  s("gbcl", {
    i(0),
    t("console.log('\x1b[42m%s\x1b[0m',"),
    i(1),
    t(")"),
    i(2)
  }),
  -- Yellow Background Console Log
  s("ybcl", {
    i(0),
    t("console.log('\x1b[43m%s\x1b[0m',"),
    i(1),
    t(")"),
    i(2)
  }),
  -- Blue Background Console Log
  s("blbcl", {
    i(0),
    t("console.log('\x1b[44m%s\x1b[0m',"),
    i(1),
    t(")"),
    i(2)
  }),
  -- Purple Background Console Log
  s("pbcl", {
    i(0),
    t("console.log('\x1b[45m%s\x1b[0m',"),
    i(1),
    t(")"),
    i(2)
  }),
  -- Cyan Background Console Log
  s("cbcl", {
    i(0),
    t("console.log('\x1b[46m%s\x1b[0m',"),
    i(1),
    t(")"),
    i(2)
  }),
  -- Grey Background Console Log
  s("gybcl", {
    i(0),
    t("console.log('\x1b[47m%s\x1b[0m',"),
    i(1),
    t(")"),
    i(2)
  }),
  -- Clean JSON Console Log
  s("cjcl", {
    i(0),
  ...
  s("clgr", {
    i(0),
    t("const consoleLogger = store => next => action => {"),
    t({ "", "\t" }),
    t("  if(action.type === 'APPEND_DEBUG_LOG') return next(action);"),
    t({ "", "\t" }),
    t("  console.log('^[[32m%s^[[0m', `=== PAYLOAD: ${JSON.stringify(action.payload, null, 2)}"),
    t(" } ===`) {", "\t"),
    t({ "", "\t" }),
    t("    return next(action)", "\n"),
    t({ "", "\t" }),
    t("  };"),
    t({ "", "\t" }),
    t("};"),
